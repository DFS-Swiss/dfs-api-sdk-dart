...
class DfsApi {
  ...
  Future<Response> call1yearStockdataWithHttpInfo(String apiKey, String symbol,) async {
  ...
  Future<Model1yearStockdataResponseModel?> call1yearStockdata(String apiKey, String symbol,) async {
    final response = await call1yearStockdataWithHttpInfo(apiKey, symbol,);
  ...
  ///
  /// * [String] symbol (required):
  Future<Response> call24hStockdataWithHttpInfo(String apiKey, String symbol,) async {
    // ignore: prefer_const_declarations
  ...
  Future<Model24hStockdataResponseModel?> call24hStockdata(String apiKey, String symbol,) async {
    final response = await call24hStockdataWithHttpInfo(apiKey, symbol,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] symbol (required):
  Future<Response> call2yearsStockdataWithHttpInfo(String apiKey, String symbol,) async {
    // ignore: prefer_const_declarations
  ...
  Future<Model2yearsStockdataResponseModel?> call2yearsStockdata(String apiKey, String symbol,) async {
    final response = await call2yearsStockdataWithHttpInfo(apiKey, symbol,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
